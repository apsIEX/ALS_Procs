...
proc PolarPhoton(w,krange,anglerange,evoff,evincr)
	string w, krange, anglerange; variable evoff,evincr
	...
	string df=newPPPlot(w,stk,enk,nk,sta,ena,na,evoff,evincr)
...
function/s newPPPlot(w,stk,enk,nk,sta,ena,na,evoff,evincr)
	string w; variable stk,enk,nk,sta,ena,na,evoff,evincr
...
Function SetdegPerPixel(ctrlName,varNum,varStr,varName) : SetVariableControl
	String ctrlName
	Variable varNum
	String varStr
	String varName
...
Window PPPlot() : Graph
	...
	Display /W=(360,186,1046,587) as "PPPlot"
	...
	SetVariable degPerPixel,pos={235,24},size={110,15},proc=SetdegPerPixel,title="degPerPixel"
	...
	PopupMenu Constant,pos={356,2},size={122,20},proc=ConstProc,title="Constant..."
	PopupMenu Constant,mode=1,popvalue="Energy",value= #"\"Energy;theta;ky;kz;hv\""
	SetVariable cval,pos={479,3},size={75,15},title=" val",value= root:PPPlot:cval
	PopupMenu SendTo,pos={455,78},size={82,20},proc=SendToProc,title="Send to..."
	...
	SetVariable kx0,pos={398,25},size={75,15},title="kx0",value= root:PPPlot:cval
	SetVariable kx1,pos={483,25},size={75,15},title="kx1",value= root:PPPlot:cval
	SetVariable ky0,pos={398,41},size={75,15},title="ky0",value= root:PPPlot:cval
	SetVariable ky1,pos={483,42},size={75,15},title="ky1",value= root:PPPlot:cval
	SetVariable kz1,pos={483,60},size={75,15},title="kz1",value= root:PPPlot:cval
	SetVariable kz0,pos={398,59},size={75,15},title="kz0",value= root:PPPlot:cval
	SetVariable nx,pos={568,24},size={75,15},title="nx",value= root:PPPlot:cval
	SetVariable ny,pos={569,40},size={75,15},title="ny",value= root:PPPlot:cval
	SetVariable nz,pos={569,57},size={75,15},title="nz",value= root:PPPlot:cval
EndMacro
