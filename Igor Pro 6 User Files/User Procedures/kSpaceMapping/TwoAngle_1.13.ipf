...
Window KPlotWin() : Graph
	...
	Display /W=(577,76,1177,608) as "KPlot"
	...
	SetWindow kwTopWin,hook=KPlotHookFcn,hookevents=3,hookcursor=5
EndMacro
...
//		if(numberbykey("modifiers",s)==upMod+1)
		...
		if((numberbykey("modifiers",s)==9)*is3D*(StrSearch(s,"EVENT:mouse",0) > 0))
			//Mac: cmd +mousedown
