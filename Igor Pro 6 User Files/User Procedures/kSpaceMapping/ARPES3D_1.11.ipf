...
proc Symmetrize(w,symmetry, rangeoption, xrange,yrange,zrange, trWave)
	string w,symmetry, rangeoption, xrange,yrange,zrange,rangeOutOption,xrout,yrout,trWave
...
function mirSymm(mirSym,img,x0,x1,y0,y1,z0,z1)
	...
	variable isLRUD=(cmpstr(suffix,"LRUD")==0)
       ...
       duplicate/o img,img0
       if(isLR||isLRUD)
       	redimension/n=(dimsize(img0,0)*2,dimsize(img0,1)) img
       ...
       if(isUD||isLRUD)
       	redimension/n=(dimsize(img,0),dimsize(img0,1)*2) img
