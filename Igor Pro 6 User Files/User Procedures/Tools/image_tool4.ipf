...
// ?? Volume: placement of Z crosshair when switching between XY, XZ, YZ
...
Function imgTabProc(name,tab)
	...
	//popupmenu selectZcursor,disable=(tab!=3)
...
Window ImageTool() : Graph
	...
	ShowInfo
	TextBox/N=title/F=0/A=MT/X=-4.28/Y=1.90/E "\\Z09f002"
	ControlBar 50
	...
	SetVariable setpinc,pos={279,26},size={30,15},disable=1,title=" "
	...
	PopupMenu popAnim,pos={461,23},size={74,20},disable=1,proc=AnimateAction,title="Animate"
	...
	PopupMenu VolModify,pos={384,23},size={65,20},disable=1,proc=VolModify,title="Modify"
	...
	ValDisplay version,pos={600,1},size={30,14},fsize=9, title="v4.00",frame=0
