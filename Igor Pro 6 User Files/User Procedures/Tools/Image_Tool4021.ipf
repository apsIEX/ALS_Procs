...
Proc ImageToolHelp()
	...
	if (V_flag==0)
		...
		Notebook ImageToolinfo, fstyle=1, text="\rNew Features:\r"
			...
			txt+="   v4.021 - Added "Last Marquee" option to color options for 3d volumes	//!!ER
...
//---------
	...
	NewDataFolder/O/S root:ImageTool
		...
		Gray_CT=p*256
		variable/g  ColorOptions, LockColors, marquee_left=0, marquee_right=1,marquee_top=0,marquee_bottom=1 //!!ER
...
Function Image_Tool() : Graph
	...
	ValDisplay version,pos={600,1},size={30,14},fsize=9, title="v4.021",frame=0	//!!ER
