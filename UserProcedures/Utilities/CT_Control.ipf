...
//JM 20160720 modified to look in Documents User Procedures/
		string User_path=SpecialDirPath("Igor Pro User Files", 0,0,0)
		NewPath/Q ColorTablePath User_path+"User Procedures:ColorTables:Names & Tables"
	endif
