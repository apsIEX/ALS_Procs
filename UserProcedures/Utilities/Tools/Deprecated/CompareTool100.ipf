...
function SetupCTool(dfn,w0,w1)
	...
	setformula ph0,"interp3d("+df+"img0_3d,x-" + df+"dx0," + df+"yval-" + df+"dy0,0)"
	setformula ph1,"interp3d("+df+"img1_3d,x-" + df+"dx1," + df+"yval-" + df+"dy1,0)"
	...
	setformula pv0x,"interp3d("+df+"img0_3d,"+df+"xval-"+df+"dx0,x,0)"
	setformula pv1x,"interp3d("+df+"img1_3d,"+df+"xval-"+df+"dx1,x,0)"
