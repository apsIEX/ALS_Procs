...
function setupcontrols(df)
	...
	variable cstarth=63,vstarth=22 , cstep=80 ,vstep=15

	SetVariable setXUnit,frame=0,noedit=1,pos={cstarth,vstarth},size={70,14},title=" ",value=$(df+"xlable")
	SetVariable setYUnit,frame=0,noedit=1,pos={cstarth + cstep,vstarth},size={70,14},title=" ",value=$(df+"ylable")
	SetVariable setZUnit,frame=0,noedit=1,pos={cstarth + 2*cstep,vstarth},size={70,14},title=" ",value=$(df+"zlable")
	SetVariable setTUnit,frame=0,noedit=1,pos={cstarth + 3*cstep,vstarth},size={70,14},title=" ",value=$(df+"tlable")
