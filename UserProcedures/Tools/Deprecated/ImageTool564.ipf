...
//	setformula $(df+"pmap") , "255*(p/255)^(abs("+df+"gamma))"
	...
	setformula $(df+"ct_h"), "root:colors:all_ct[invertct*(255-pmap[p])+(invertct==0)*pmap[p]][q][whichCTh]"
	setformula $(df+"ct_v"), "root:colors:all_ct[invertct*(255-pmap[p])+(invertct==0)*pmap[p]][q][whichCTv]"
	setformula $(df+"ct_zt"), "root:colors:all_ct[invertct*(255-pmap[p])+(invertct==0)*pmap[p]][q][whichCTzt]"
