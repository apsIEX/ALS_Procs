...
#include "colorTables"
	static constant MAJOR_VERSION = 5.72
	...
	//		 scroll wheel support for cursor movement	
...
Function Norm1D_AxisMenu(PU_Struct)
	...
	if(PU_Struct.eventCode==2)
		...
		execute "SetVariable c"+nn+"_x0,limits={"+num2str(x0L)+","+num2str(x1L)+","+num2str(dimdelta(w,axis))+"},value="+df+nn+"_X0, title=\""+axistitle(df,axis)+"0\""
		execute "SetVariable c"+nn+"_x1,limits={"+num2str(x0L)+","+num2str(x1L)+","+num2str(dimdelta(w,axis))+"},value="+df+nn+"_X1, title=\""+axistitle(df,axis)+"1\""
	endif
end
