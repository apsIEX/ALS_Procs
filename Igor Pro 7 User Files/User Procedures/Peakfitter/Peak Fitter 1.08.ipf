...
Window PFPanel() : Panel
	...
	NewPanel /W=(651,456,1223,793) as "PFPanel"
	...
	SetDrawEnv fillfgc= (32768,54615,65535)
	DrawRect 555,16,438,102
	Button init,pos={446,121},size={100,20},proc=startButtonFunc,title="initialize"
	PopupMenu background,pos={12,26},size={88,20},proc=selectBkgd,title="type"
	...
	SetVariable channel,pos={286,115},size={143,15},proc=SetVarChannel,title="channel"
	SetVariable channel,fSize=9,limits={0,1,1},value= root:PF:channel
	SetVariable peak,pos={80,114},size={80,18},proc=peakVar,title="peak",fSize=12
	SetVariable peak,limits={1,1,1},value= root:PF:peak
	...
	SetVariable editASYM,pos={9,260},size={100,15},proc=editASYM,title="ASYM"
	SetVariable editASYM,fSize=9,limits={-Inf,Inf,0.02},value= root:PF:ASYM
	SetVariable editSPLIT,pos={9,285},size={100,15},proc=editSPLIT,title="SPLIT"
	SetVariable editSPLIT,fSize=9,limits={-Inf,Inf,0.1},value= root:PF:SPLIT
	SetVariable editRATIO,pos={9,304},size={100,15},proc=editRATIO,title="RATIO"
	...
	PopupMenu GWhold,pos={115,238},size={96,20},proc=SetParmMenu
	PopupMenu GWhold,mode=1,popvalue="Free           ",value= #"\"Free           ;Fixed         ;Between;the value from peak #...\""
	PopupMenu ASYMhold,pos={115,257},size={96,20},proc=SetParmMenu
	PopupMenu ASYMhold,mode=1,popvalue="Free           ",value= #"\"Free           ;Fixed         ;Between;the value from peak #...\""
	PopupMenu SPLIThold,pos={115,283},size={96,20},proc=SetParmMenu
	PopupMenu SPLIThold,mode=1,popvalue="Free           ",value= #"\"Free           ;Fixed         ;Between;the value from peak #...\""
	PopupMenu RATIOhold,pos={115,302},size={96,20},proc=SetParmMenu
	PopupMenu RATIOhold,mode=1,popvalue="Free           ",value= #"\"Free           ;Fixed         ;Between;the value from peak #...\""
	SetVariable ampRelPeak,pos={298,197},size={50,15},proc=SetParms,title=" "
	SetVariable ampRelPeak,fSize=9,limits={1,Inf,1},value= root:PF:ampRelPeak
	SetVariable LWRelPeak,pos={298,223},size={50,15},proc=SetParms,title=" ",fSize=9
	SetVariable LWRelPeak,limits={1,Inf,1},value= root:PF:LWRelPeak
	SetVariable GWRelPeak,pos={298,242},size={50,15},proc=SetParms,title=" ",fSize=9
	SetVariable GWRelPeak,limits={1,Inf,1},value= root:PF:GWRelPeak
	SetVariable ASYMRelPeak,pos={298,260},size={50,15},proc=SetParms,title=" "
	SetVariable ASYMRelPeak,fSize=9
	SetVariable ASYMRelPeak,limits={1,Inf,1},value= root:PF:ASYMRelPeak
	SetVariable SPLITRelPeak,pos={298,286},size={50,15},proc=SetParms,title=" "
	SetVariable SPLITRelPeak,fSize=9
	SetVariable SPLITRelPeak,limits={1,Inf,1},value= root:PF:SPLITRelPeak
	SetVariable RATIORelPeak,pos={298,303},size={50,15},proc=SetParms,title=" "
	SetVariable RATIORelPeak,fSize=9
	SetVariable RATIORelPeak,limits={1,Inf,1},value= root:PF:RATIORelPeak
	SetVariable posRelVal,pos={351,177},size={75,15},proc=SetConstraintParms,title="plus  "
	SetVariable posRelVal,fSize=9,value= root:PF:posRelVal
	SetVariable ampRelVal,pos={351,197},size={75,15},proc=SetParms,title="times"
	SetVariable ampRelVal,fSize=9,value= root:PF:ampRelVal
	SetVariable LWRelVal,pos={351,223},size={75,15},proc=SetParms,title="times"
	SetVariable LWRelVal,fSize=9,value= root:PF:LWRelVal
	SetVariable GWRelVal,pos={351,242},size={75,15},proc=SetParms,title="times"
	SetVariable GWRelVal,fSize=9,value= root:PF:GWRelVal
	SetVariable ASYMRelVal,pos={351,259},size={75,15},proc=SetParms,title="times"
	SetVariable ASYMRelVal,fSize=9,value= root:PF:ASYMRelVal
	SetVariable SPLITRelVal,pos={350,286},size={75,15},proc=SetParms,title="plus  "
	SetVariable SPLITRelVal,fSize=9,value= root:PF:SPLITRelVal
	SetVariable RATIORelVal,pos={350,303},size={75,15},proc=SetParms,title="times"
	SetVariable RATIORelVal,fSize=9,value= root:PF:RATIORelVal
	SetVariable POSlo,pos={208,177},size={75,15},proc=SetParms,title="Lo",fSize=9
	SetVariable POSlo,value= root:PF:POSlo
	SetVariable AMPlo,pos={208,197},size={75,15},proc=SetParms,title="Lo",fSize=9
	SetVariable AMPlo,value= root:PF:AMPlo
	SetVariable LWlo,pos={208,221},size={75,15},proc=SetParms,title="Lo",fSize=9
	SetVariable LWlo,value= root:PF:LWlo
	SetVariable GWlo,pos={208,240},size={75,15},proc=SetParms,title="Lo",fSize=9
	SetVariable GWlo,value= root:PF:GWlo
	SetVariable ASYMlo,pos={208,260},size={75,15},proc=SetParms,title="Lo",fSize=9
	SetVariable ASYMlo,value= root:PF:ASYMlo
	SetVariable SPLITlo,pos={208,285},size={75,15},proc=SetParms,title="Lo",fSize=9
	SetVariable SPLITlo,value= root:PF:SPLITlo
	SetVariable RATIOlo,pos={208,304},size={75,15},proc=SetParms,title="Lo",fSize=9
	SetVariable RATIOlo,value= root:PF:RATIOlo
	SetVariable POShi,pos={298,177},size={75,15},proc=SetParms,title="Hi",fSize=9
	SetVariable POShi,value= root:PF:POShi
	SetVariable AMPhi,pos={297,197},size={75,15},proc=SetParms,title="Hi",fSize=9
	SetVariable AMPhi,value= root:PF:AMPhi
	SetVariable LWhi,pos={297,221},size={75,15},proc=SetParms,title="Hi",fSize=9
	SetVariable LWhi,value= root:PF:LWhi
	SetVariable GWhi,pos={297,240},size={75,15},proc=SetParms,title="Hi",fSize=9
	SetVariable GWhi,value= root:PF:GWhi
	SetVariable ASYMhi,pos={296,260},size={75,15},proc=SetParms,title="Hi",fSize=9
	SetVariable ASYMhi,value= root:PF:ASYMhi
	SetVariable SPLIThi,pos={296,285},size={75,15},proc=SetParms,title="Hi",fSize=9
	SetVariable SPLIThi,value= root:PF:SPLIThi
	SetVariable RATIOhi,pos={296,304},size={75,15},proc=SetParms,title="Hi",fSize=9
	SetVariable RATIOhi,value= root:PF:RATIOhi
	Button FitSpectrum,pos={447,153},size={100,20},proc=fitChannel,title="Fit Spectrum"
	Button fitspectra,pos={447,214},size={100,20},proc=fitChannels,title="Fit Spectra..."
	...
	SetVariable bkgd1,pos={12,66},size={90,15},proc=editBkgdProc,title="1",fSize=9
	SetVariable bkgd1,value= root:PF:bkgd1
	SetVariable bkgd2,pos={12,81},size={90,15},proc=editBkgdProc,title="2",fSize=9
	SetVariable bkgd2,value= root:PF:bkgd2
	SetVariable bkgd3,pos={129,51},size={90,15},proc=editBkgdProc,title="3",fSize=9
	SetVariable bkgd3,value= root:PF:bkgd3
	SetVariable bkgd4,pos={129,66},size={90,15},proc=editBkgdProc,title="4",fSize=9
	SetVariable bkgd4,value= root:PF:bkgd4
	...
	CheckBox fix1,pos={103,66},size={16,14},proc=SetFixedFcn,title="",value= 0
	CheckBox fix2,pos={103,82},size={16,14},proc=SetFixedFcn,title="",value= 0
	CheckBox fix3,pos={220,52},size={16,14},proc=SetFixedFcn,title="",value= 0
	CheckBox fix4,pos={220,67},size={16,14},proc=SetFixedFcn,title="",value= 0
	CheckBox fix5,pos={220,82},size={16,14},proc=SetFixedFcn,title="",value= 0
	SetVariable bkgd5,pos={129,81},size={90,15},proc=editBkgdProc,title="5",fSize=9
	SetVariable bkgd5,value= root:PF:bkgd5
	SetVariable bkgd6,pos={246,51},size={90,15},proc=editBkgdProc,title="6",fSize=9
	SetVariable bkgd6,value= root:PF:bkgd6
	CheckBox fix6,pos={338,51},size={16,14},proc=SetFixedFcn,title="",value= 0
	...
	Button fit2hist,pos={447,233},size={100,20},proc=fit2history,title="Fit --> History"
	Button hist2fit,pos={447,252},size={100,20},proc=history2fit,title="Fit <-- History"
	Button fitReport,pos={447,172},size={100,20},proc=FitReport,title="Fit Report"
	Button SeriesReport,pos={447,271},size={100,20},proc=SeriesReport,title="Series Report"
	PopupMenu thispktyp,pos={161,113},size={108,20},proc=changetype,title="Type"
	PopupMenu thispktyp,mode=5,popvalue="Gaussian",value= #"\"Lor;Lor_Gauss;Lor_Doniach;Lor_Don_Gauss;Gaussian;Gauss Step;Lineshape\""
	SetVariable posRelPeak,pos={298,177},size={50,15},proc=SetParms,title=" "
	SetVariable posRelPeak,fSize=9,limits={1,Inf,1},value= root:PF:posRelPeak
	CheckBox FECheckBox,pos={488,25},size={57,14},proc=FECheckBoxProc,title="Has FE?"
	CheckBox FECheckBox,value= 0
	SetVariable FEPos,pos={443,45},size={90,15},proc=editBkgdProc,title="Pos"
	SetVariable FEPos,fSize=9,value= root:PF:FEPos
	CheckBox fixFEPOS,pos={536,46},size={16,14},proc=SetFixedFcn,title="",value= 0
	CheckBox fixFEWid,pos={536,63},size={16,14},proc=SetFixedFcn,title="",value= 0
	SetVariable FEWidth,pos={443,63},size={90,15},proc=editBkgdProc,title="Width"
	SetVariable FEWidth,fSize=9,value= root:PF:FEWidth
	Button showData,pos={449,300},size={40,20},proc=DataWindowProc,title="Data"
	Button showHistory,pos={492,300},size={50,20},proc=HistoryWindowProc,title="History"
EndMacro
