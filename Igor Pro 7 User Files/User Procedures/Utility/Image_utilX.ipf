...
//---------------
	if (exists("XHair")==0)
		make/o XHair={-INF,0,INF, nan, 0,0}, YHAIR={0,0,0,nan,-INF,INF}
	endif
	PauseUpdate; Silent 1
	variable xmid, ymid
	GetAxis/Q left
...
//================
	...
	variable overwrite=KeySet("O", opt)*(strlen(newimgn)==0)
	newimgn=SelectString(overwrite, newimgn, "root:tmp:imgtmp")
...
Function TileImages( winnam, nx, ny )
//==============
	string winnam
	variable nx, ny
