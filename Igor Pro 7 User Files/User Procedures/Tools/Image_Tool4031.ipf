...
menu "GraphMarquee", dynamic
	"-"
		Imagtool4marqueemenus("AdjustCT")
		Imagtool4marqueemenus("AreaX")
		Imagtool4marqueemenus("Find_Edge")
		Imagtool4marqueemenus("Find_Peak")
		Imagtool4marqueemenus("ReGridXY")
		Imagtool4marqueemenus("Crop")
		Imagtool4marqueemenus("NormX")
		Imagtool4marqueemenus("NormY")
		Imagtool4marqueemenus("NormZ")
		Imagtool4marqueemenus("OffsetZ")
		Imagtool4marqueemenus("NoiseStats")
	end
end

function /s Imagtool4marqueemenus(name)
	string name
	string wn=winname(0,1)
	if((strsearch(wn,"ImageTool",0)>=0)&&(strsearch(wn,"V",0)==-1))
		return name
	endif
	return ""
end
...
//---------
	...
	NewDataFolder/O/S $df		
		...
		variable ctdim=numpnts(root:colors:colorTableNames)
		make/o/n=(256,3,ctdim) ALL_CT
...
Window ImageTool() : Graph
	...
	Button exportvolume,pos={197,22},size={55,20},disable=1,title="Volume", proc=ExportVolumeFct
	Button exportvolume,help={"Export current (modified) volume to root (name prompted for)."}
	ValDisplay version,pos={595,1},size={35,14},fsize=9, title="v4.026",frame=0  
	ValDisplay version,limits={0,0,0},barmisc={0,1000},value= #"0"
	SetWindow kwTopWin,hook=imgHookFcn,hookevents=3
EndMacro
